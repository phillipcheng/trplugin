...
DIAMETER_ID=ali1.mymac
mkdir /opt/fd/conf
cd /opt/fd/conf
openssl req -new -batch -x509 -days 3650 -nodes -newkey rsa:1024 -out ali1.cert.pem -keyout ali1.privkey.pem -subj /CN=ali1.mymac
